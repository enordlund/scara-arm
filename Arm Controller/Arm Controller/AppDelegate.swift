...
// Stuff from bluetooth sample app
...
let kSavedENAppearanceDefaultsKey = "Appearance"

let kSavedLastUpdatedDefaultsKey = "LastUpdated"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	lazy var persistentContainer: NSPersistentContainer = {
	    ...
	    */
	    let container = NSPersistentContainer(name: "RGB_Controller")
